            ...
            <div>
                <section >
                    ...
                    <article className="Units photos">
                        ...
                        <img className="photos img" src="/4.png"></img>
                        <img className="photos img" src="/5.png"></img>*/}
                        <div className={`image img${isFlipped ? 'flipped' : ''}`} onClick={handleImageClick}>
                            <img className="photos img" src="https://image.lexica.art/full_jpg/621d1c64-ef6e-49e2-b2f1-851fc51686db" alt="1" />
                            
                        </div>

                        <div className={`container-content ${isFlipped ? 'visible' : ''}`}>
                            <div className="Units photos">
                                <div className="photos img">
                                    <p>Contenido del contenedor visible después de voltear la imagen</p>
                                </div>
