    ...
    <>
      <div>
        <div className="containerTable2">
          {/*Esta clase le pertenece a Jordan*/}
            ...
            <tbody>
              {filteredData.map((data) => (
                <tr key={data.Unidad}>
                  ...
                  <div>
                    <button className="masInfobutton" onClick={openModal}>
                      Más información
                    </button>
                    {isOpen && (
                      <div className="modal-overlay">
                        <div className="modal-content1">
                          <button
                            className=".modal-content button buttonMas"
                            onClick={closeModal}
                          >
                            X
                          </button>
                          ...
                          <h1 className="DaModalExit">
                            {" "}
                            Fecha de salida:{" "}
                            <h2 className="notaModal">
                              {data.fecha_salida}{" "}
                            </h2>{" "}
                          </h1>
                          ...
                          <h1 className="DaModalExit">
                            {" "}
                            Estado:{" "}
                            <h2 className="notaModal">{data.Disponibilidad}</h2>
                          </h1>
                          ...
                          <h1 className="DaModalExit">
                            {" "}
                            Materiales Utiizados{" "}
                            <h2 className="notaModal">{data.Modelo}</h2>{" "}
                          </h1>
                          <button className="buttonAcep2" onClick={closeModal}>
                            Aceptar
                          </button>
                        </div>
                      </div>
          ...
          <button className="buttonSearchMant" onClick={openModal2}>
            Agregar
          </button>
          {isOpen2 && (
            <div className="modal-overlay2">
              <div className="modal-content2">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button className="buttonAcep1" type="submit">
                    Aceptar
                  </button>
                </form>
              </div>
