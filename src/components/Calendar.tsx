                ...
                <div className="contp">
                    <article>
                        <div>
                            ...
                            />
                            <button className="addCita" onClick={openModal2} >Agregar</button>
                            <div>
                ...
                {isOpen2 && (
                    ...
                    <div className="Citass">
                        ...
                        <div className="modal-contento">
                            ...
                            <input className='impAdd' type="date" id="fecha_entrada"  value={Fecha_Entrada} onChange={(e)=>setFecha_Entrada(e.target.value)}/>

                            <h2 className='textAdd'> Tipo de Servicio</h2>
                            <input className='impAdd' type="text" id="asunto"  value={Asunto} onChange={(e)=>setAsunto(e.target.value)} placeholder=' General/Preventivo' />

                            <button className='buttonenviar' onClick={closeModal}>Aceptar</button>
                            </form>
